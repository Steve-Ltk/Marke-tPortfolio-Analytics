...
namespace MarketPortfolioAnalytics.Models
{
    ...
    public class AssetPrice
    {
        ...
        /// <summary>Référence vers l'actif dont c'est le prix.</summary>
        [Required]
        ...
        /// <summary>Prix d'ouverture de la séance. Optionnel.</summary>
        [Column(TypeName = "decimal(18,6)")]
        public decimal? Open { get; set; }

        /// <summary>Prix le plus haut de la séance. Optionnel.</summary>
        [Column(TypeName = "decimal(18,6)")]
        public decimal? High { get; set; }

        /// <summary>Prix le plus bas de la séance. Optionnel.</summary>
        [Column(TypeName = "decimal(18,6)")]
        ...
        /// Pas toujours disponible pour les obligations.
        /// </summary>
